    ...
    return (
        ...
        >
            ...
            <mesh position={[0, 0.095, 0]} rotation={[Math.PI / 2, 0, 0]}>
                ...
                <meshStandardMaterial
                    color={locked ? "#64748b" : "#00ccff"}
                    emissive={locked ? "#111827" : "#00aaff"}
                    emissiveIntensity={locked ? 0.45 : hovered ? 3.3 : 2.3}
                    roughness={0.28}
                />
            </mesh>
            ...
            <mesh position={[0, 0.16, 0]}>
                ...
                <meshStandardMaterial
                    color={locked ? "#94a3b8" : "#69e8ff"}
                    emissive={locked ? "#1f2937" : "#00aaff"}
            ...
            <pointLight
                ...
                intensity={locked ? 0.18 : hovered ? 1.05 : 0.55}
                distance={1.7}
            />
            ...
            <mesh position={[0, 0.305, 0]} rotation={[Math.PI / 2, 0, 0]}>
                <ringGeometry args={[0.082, 0.092, 24]} />
                <meshBasicMaterial
                    color={locked ? "#64748b" : "#00aaff"}
                    toneMapped={false}
                />
